...
export const selectAllSpotsArry = createSelector(selectSpot, (spot) =>
  Object.values(spot.allSpots)
);

export const selectCurrentUserSpots = createSelector(
  selectSpot,
  (spot) => Object.values(spot.currentUserSpots) || []
);

export const selectSpotById = createSelector(
  [selectSpot, (state, id) => id],
